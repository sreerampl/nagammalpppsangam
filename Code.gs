...
//   (Pen Pulli Varavu is NOT pre-populated — tracked by donor name)
...
// inflate income totals until an admin confirms collection.
// ============================================================
...
function handleCreateFinancialYear(data, email) {
  ...
  families.forEach(function(f) {
    ...
    // Pen Pulli Varavu is NOT pre-populated — it's tracked by donor name
    // (women donors), not by the family roster, so it uses the standard
    // income list (IncomeView) with manual entry.
